<h1 align="center" style="border-bottom: none;"> Encontrando Nemo</h1>
<h3 align="center">Build a demo using the Watson Visual Recognition service to develop a fish classifier. The tool was designed in order to help people identify the fish they caught.</h3>
<p align="center">
...
✨ **Demo:** https://encontrandonemo.mybluemix.net/✨
...
2.  Open the _.env_ file and add the service credentials depending on your environment.
    ...
    ```
    WATSON_VISION_COMBINED_APIKEY=<Digite a API Key do Serviço>
    WATSON_VISION_COMBINED_URL=<Digite a URL do Serviço>
    ```
...
1. Target a Cloud Foundry organization and space.
   ...
   ```
   ibmcloud login  -o <Espaço> -s <Grupo>  -sso
   ```
